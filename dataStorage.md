...
All systems need a config file, which determines some basics like unit groups.
...
```json
{
    "legalDisclaimer": "A specific legan notice to comply with guidelines/licenses.",
    "unitGroups": [
