...
import type { SettingsTreeInputNode, SettingsTreeNode } from '../types';
/**
...
export abstract class ConverterSetting {
	...
	private static settingInputTemplate = new Template('converter-setting-input-template');
	private static settingSelectTemplate = new Template('converter-setting-select-template');

	constructor(element: Element | null) {
		if (!element) throw new ProgramError('Setting element not found on template');
