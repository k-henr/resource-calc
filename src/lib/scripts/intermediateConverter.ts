...
export class IntermediateConverter {
	...
	private static infoPanel = document.querySelector<HTMLElement>('#rc-info-panel')!;
	...
	constructor(
		...
		// depend on settings)
		this.infoElement.querySelector<HTMLImageElement>('.rc-info-image')!.src = this.displayImage;
	...
	public makeConverter(ingr: ConverterIngredient[], prod: ConverterIngredient[]): Converter {
