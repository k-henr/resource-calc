...
export class ResourceNode implements ResourceTree {
	...
	private static converterIngredientTemplate = new Template('converter-ingredient-template');
	...
	public updateElements(multiplier: Rational, _: ConverterSettings) {
		...
		for (const el of this.elements) {
			el.querySelector<HTMLElement>('.converter-ingredient-amount')!.innerText = newContent;
		}
	}
