...
import type { ConverterDependency, ConverterIngredient, SettingsTreeNode } from '../types';
...
export class MultiplierNode implements ResourceTree {
	...
	public addResourcesToList(
		...
		this.resource.addResourcesToList(output, converterDependencies, settings, multiplier);
		return output;
	}
}
